...
include { TRIM_ADAPT; TRIM_4_NUCL; KRAKEN2; BRACKEN; BWA_INDEX_FULL_GENOME; BWA_MEM_BAM_SORT_FULL_GENOME; SAMTOOLS_INDEX; SAMTOOLS_CONSENSUS_LITE; SAMTOOLS_STATS; MEGAHIT; UNICYCLER; DIAMOND } from '../modules.nf'
...
workflow TAXONOMY_ANALYSIS_SIMPLE {
  ...
  emit: 
     FQ1.out | concat(KRAKEN2.out.report) | concat(BRACKEN.out) | concat(METAPHLAN1.out.report) | collect
     //FASTQC.out | concat(KRAKEN2.out) | collect
}